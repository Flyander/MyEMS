									...
									<div class="card-body">
                                        <div class="row">
                                                        ...
                                                        <a style="text-decoration: none;" href="researchPatient">
                                                            <div class="text-white d-flex h-100 mask aqua-gradient-rgba">
                                                                <div class="first-content align-self-center p-3">
                                                                    ...
                                                                    <p class="lead mb-0">Rechercher un patient dans tout les dossiers médicaux</p>
                                                                </div>
                                                            </div>
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <div class="card gradient-card">
                                                    <div class="card-image" style="background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSo3dkGXkGaRtX5eVyedNs2xtJt_Vq1BIjzoA&usqp=CAU);">
                                                        <a style="text-decoration: none;" href="#!">
                                                            <div class="text-white d-flex h-100 mask peach-gradient-rgba">
                                                                <div class="first-content align-self-center p-3">
                                                                    <h3 class="test-title">Rapport d'intervention</h3>
                                                                    <p class="lead mb-0">Fiche bilan suite à une intervention du LSFD</p>
                                                                </div>
                                                            </div>
                                                        </a>
                                                    </div>
